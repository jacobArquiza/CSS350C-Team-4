...
export default function Features11({content}: props) {
    return (
            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="mx-auto grid gap-2 sm:grid-cols-5">
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
                        <CardHeader>
                            <div className="md:p-6">
                                <p className="font-medium">{content.featureOneTitle}</p>
                                <p className="text-muted-foreground mt-3 max-w-sm text-sm">{content.featureOneDescription}</p>
                            </div>
                        </CardHeader>
                    ...
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-2 sm:rounded-none sm:rounded-tr-xl">
                        <p className="mx-auto my-6 max-w-md text-balance px-6 text-center text-lg font-semibold sm:text-2xl md:p-6">{content.featureTwoTitle}</p>
                    ...
                    <Card className="group p-6 shadow-zinc-950/5 sm:col-span-2 sm:rounded-none sm:rounded-bl-xl md:p-12">
                        <p className="mx-auto mb-12 max-w-md text-balance text-center text-lg font-semibold sm:text-2xl">{content.featureThreeTitle}</p>
                    ...
                    <Card className="group relative shadow-zinc-950/5 sm:col-span-3 sm:rounded-none sm:rounded-br-xl">
                        <CardHeader className="p-6 md:p-12">
                            <p className="font-medium">{content.featureFourTitle}</p>
                            <p className="text-muted-foreground mt-2 max-w-sm text-sm">{content.featureFourDescription}</p>
                        </CardHeader>
