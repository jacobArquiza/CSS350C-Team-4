            ...
            <div className="mx-auto max-w-5xl border-t px-6">
                ...
                <div className="mt-12 gap-4 sm:grid sm:grid-cols-2 md:mt-24">
                    ...
                    <div className="mt-6 sm:mt-0">
                        <p>Meet our dedicated team, working hard to further our mission.</p>
                    </div>
                </div>
                            ...
                            <div
                                ...
                                <div className="px-2 pt-2 sm:pb-0 sm:pt-4">
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <div className='text-muted-foreground inline-block translate-y-6 text-sm opacity-0 transition duration-300 group-hover:translate-y-0 group-hover:opacity-100 pt-3'>
                                            {member.paragraph}
                                        </div>
                                    </div>
                                </div>
