                            ...
                            <div
                                ...
                                <div className="px-2 pt-2 sm:pb-0 sm:pt-4">
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <div className='text-muted-foreground inline-block translate-y-6 text-sm opacity-0 transition duration-300 group-hover:translate-y-0 group-hover:opacity-100'>
                                            {member.paragraph}
                                        </div>
                                    </div>
                                </div>
